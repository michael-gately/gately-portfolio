...
<div className='pl-8 md:pl-0 pt-8 pr-16'>
    ...
    <div className={bodyPoppins.className.concat(" ", " pt-8 text-left text-sm md:text-base")}>
        ...
        have a front end form that is easy and consistent. I was able to do this using a django server
        with an external Shipping Label API, MIME email generation, and pdfkit to create a purchase order to attach.
    </div>
</div>
)
}