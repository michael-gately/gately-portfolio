...
<main className="md:pl-0 pt-8 text-left">
  ...
  <div className="pl-32">
    <Link href="/skills">
      <button className={bodyPoppins.className.concat(" "," bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-10 rounded mb-80")}>Skills</button>
    </Link>
    <Link href="/work-history">
    <button className={bodyPoppins.className.concat(" "," ml-8 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded mb-80")}>Experience</button>
    </Link>
  </div>
